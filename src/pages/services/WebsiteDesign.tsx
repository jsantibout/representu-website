  ...
  return (
    <div className="min-h-screen">
      ...
      <div className="pt-20">
        ...
        {/* <div className="w-full h-[28rem] mb-8 bg-gradient-to-br from-primary/20 to-accent/20 flex items-center justify-center">
          <div className="text-center space-y-4">
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              Professional, responsive websites that showcase your organization's mission and drive engagement
            </p>
          </div>
        </div> */}
            ...
            <div className="max-w-4xl mx-auto">
              <div className="text-center mb-16 space-y-4 animate-fade-in">
                <h2 className="text-4xl lg:text-5xl font-bold">
                  <span className="text-foreground">Website Design & </span>
                  <span className="bg-gradient-primary bg-clip-text text-transparent">Developement </span>
                </h2>
